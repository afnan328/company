...
const featuresData = [
  {
    ...
    description:
      "Seize the Opportunity to Transform Your Language Skills and Expand Your Horizons.",
  ...
  },
  {
    ...
    description:
      "Practice and improve your language skills with experienced native speakers.",
    icon: "/images/icons/diagonal-arrow-right-up.svg",
  },
];
